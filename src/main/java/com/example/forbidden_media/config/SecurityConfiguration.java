package com.example.forbidden_media.config;

import com.example.forbidden_media.repositories.UserRepository;
import com.example.forbidden_media.services.ApplicationUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http.
                ...
                // the URL-s below are available for all users - logged in and anonymous
                        requestMatchers("/", "/contact", "/resume", "/projects", "/contact", "/users/account/**","/meets/details/**", "/api/**").permitAll().
                // only for moderators
